my_indicator_name = "v1.0.1 [ETH1H双向-+153.35] 趋势回踩突破（多空独立四路版）"
my_indicator_description = "v1.0.6 的双向扩展：多头沿用趋势回踩/突破入场；空头为独立镜像建模（下跌趋势 + RSI 弱势 + 向下突破或反弹受阻），不再复用多头离场条件作为开空信号。四路信号显式表达，退出由引擎风控负责，指标侧 close_* 仅做结构性离场。"
# 初始资金：$10000.00 杠杆：3x 交易方向：双向
